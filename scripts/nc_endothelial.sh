...
python train.py --data data/endothelial.csv --reference_gene data/human_filtered.csv --output_dir ./test/endothelial --immune_cell endothelial --learning_rate 0.05 --num_epochs 100 --patience 5 --delta 0.0001  --n_genes 10000    
