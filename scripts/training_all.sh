...
python train.py --data data/training_all.csv --reference_gene data/reference.csv --output_dir ./test/all_gpu_2500_2 --immune_cell tcell --learning_rate 0.0001 --num_epochs 1000 --patience 5 --delta 0.0001