...
python train.py --data data/visiumhd/macrophage.csv --reference_gene data/human_filtered.csv --output_dir finalize_model_visiumhd_top500_relative/macrophage --immune_cell macrophage --learning_rate 0.05 --num_epochs 10 --patience 5 --delta 0.0001  --n_genes 500    
