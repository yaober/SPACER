...
python train.py --data data/visiumhd/b_cell.csv --reference_gene data/human_filtered.csv --output_dir finalize_model_visiumhd_top500/bcell --immune_cell bcell --learning_rate 0.05 --num_epochs 10 --patience 5 --delta 0.0001  --n_genes 500    
