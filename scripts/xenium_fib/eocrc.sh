...
python train.py --data  /archive/DPDS/Xiao_lab/shared/jia_yao/xenium32/data/data4spacer/eocrc.csv --reference_gene data/human_filtered.csv --output_dir /archive/DPDS/Xiao_lab/shared/jia_yao/xenium32/data/data4spacer/spacer_results/eocrc --immune_cell fibroblast --learning_rate 0.05 --num_epochs 10 --patience 5 --delta 0.0001  --n_genes 372 --selection positive 
