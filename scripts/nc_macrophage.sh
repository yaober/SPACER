...
python train.py --data data/negative_control_macrophage_high.csv --reference_gene data/human.csv --output_dir ./negative_control_high/macrophage --immune_cell macrophage --learning_rate 0.1 --num_epochs 1000 --patience 5 --delta 0.0001  --n_genes 10000    
