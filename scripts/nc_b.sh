...
python train.py --data data/b_cell.csv --reference_gene data/human_filtered.csv --output_dir ./test_clloss_k=4/bcell --immune_cell bcell --learning_rate 0.1 --num_epochs 100 --patience 5 --delta 0.0001  --n_genes 10000    
