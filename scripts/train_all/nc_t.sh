...
python train.py --data  data/all_data/t_cell.csv --reference_gene data/human_filtered.csv --output_dir finalize_model_all_top500_test/tcell --immune_cell tcell --learning_rate 0.01 --num_epochs 50 --patience 5 --delta 0.0001  --n_genes 500    
