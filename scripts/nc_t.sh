...
python train.py --data data/t_cell.csv --reference_gene data/human_filtered.csv --output_dir ./test_clloss_k=4_AdamW/tcell --immune_cell tcell --learning_rate 0.1 --num_epochs 100 --patience 5 --delta 0.0001  --n_genes 10000    
