...
python train.py --data data/t_cell.csv --reference_gene data/human_filtered.csv --output_dir ./finalize_model/tcell --immune_cell tcell --learning_rate 0.05 --num_epochs 100 --patience 5 --delta 0.0001  --n_genes 10000    
